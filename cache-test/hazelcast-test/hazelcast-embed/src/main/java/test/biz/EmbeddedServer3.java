...
public class EmbeddedServer3 implements Constant {
    ...
    public static void main(String[] args) {
        ...
        // 存入数据
        map.put("key3", "Hello 2026 from server 3");

        // 读取数据
        log.info("数据内容: {}", map.get("key3"));
        log.info("集群中的 Map 大小: {}", map.size());

        // 保持运行以观察集群发现
        log.info("Server 3 运行中...");
    }
