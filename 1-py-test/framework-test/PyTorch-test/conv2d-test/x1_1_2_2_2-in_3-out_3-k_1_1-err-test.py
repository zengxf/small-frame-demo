...
测试 PyTorch Conv2d：
    ...
    Conv2d 层：3 in, 3 out, 1x1 kernel
"""
...
conv = nn.Conv2d(in_channels=3, out_channels=3, kernel_size=1, bias=False)
...
# 前向传播
output = conv(x)  # python-BaseException
...
...
...
RuntimeError: Given groups=1, weight of size [3, 3, 1, 1], expected input[1, 2, 2, 2] to have 3 channels, but got 2 channels instead
"""
