...
import test.string.encrypt.codec.RSAEncrypt;
...
public class RSASignDemo {
    ...
    static final String fileName = RSAEncrypt.DIR + "/test.txt";
     ...
     * @return 签名结果
     */
    public byte[] rsaSign(byte[] data, PrivateKey priKey) throws SignatureException {
        try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            //文件签名保存
            String signPath = RSAEncrypt.DIR + "/fileSign.sign";
            saveFile(fileSign, signPath);
